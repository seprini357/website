      ...
      <div className="container">
        ...
        <main className="main-grid">
          <section className="left-col">
            <h1 className="main-title">
              당신만의<br /> <span className="green">스마트 농장</span>,<br />
              지금 시작하세요
            </h1>
            <p className="subtitle">
              환경 데이터부터 농사 기반 챗봇까지<br />
              스마트팜 대시보드에서 한눈에 확인할 수 있어요.
            </p>
            <form className="serial-form" onSubmit={(e) => { e.preventDefault(); handleEnterClick(); }}>
              <input type="text" placeholder="디바이스 일련번호를 입력하세요." />
        ...
        <section className="features-section">
          <div className="feature-card" onClick={() => handleFeatureClick('/')}>
            ...
            <div className="feature-desc">농작물 상태와 환경 정보를 한눈에 확인하고 편리하게 관리하세요.</div>
          </div>
          <div className="feature-card" onClick={() => handleFeatureClick('/market')}>
          ...
          <div className="feature-card" onClick={() => handleFeatureClick('/price')}>
            ...
            <div className="feature-desc">AI가 가격변동을 예측해 최적의 농작물 가격을 알려드립니다.</div>
          </div>
        </section>
        <section className="grow-section">
          <h2 className="grow-title">Grow Anything, Anytime</h2>
          <p className="grow-desc">
            당신이 키우고 싶은 모든 작물, 이곳에서 시작됩니다.<br />
            스마트팜으로 언제든지 가능합니다.
          </p>
